   ...
   $('.ajax-link').click( function() {
	...
	<!-- ================== -->
          ...
          @endif
				...
				Poetic Recitation Competition Rules</h3>
			</div>
					<!-- /primary heading -->
...
<h1>CONDITIONS AND GUIDELINES FOR POETIC RECITATION</h1>

<h3>Date: 10.02.2020 Time: 9.30 a.m.</h3>

<h4>Venue: Balwant Gargi Open Air Theatre, Panjab University, Chandigarh</h4>
...
<ol>
	...
	<li>Participants in age group (s) above 12 yrs. will be allowed to recite only self-composed poems.</li>
	...
	<li>The participant is free to choose his/her area of interest.</li>
	<li>No outside assistance will be allowed.</li>
	<li>No help from any written material will be allowed.</li>
	<li>No vulgarity will be allowed.</li>
	<li>Time allotted for each performance will be upto 5 minutes.</li>
	<li>Poems can be recited in any of the regional language.</li>
