                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <div id="page_title" class="wdp_margin_top_6">
                            <div class="container text-center">
                                <img src="{{url('home/images/leaves-rose.png')}}" class="center-block img-responsive flower-img" alt="">
                                <h2>Gallery</h2>
                                <img src="{{url('home/images/line.png')}}" class="center-block img-responsive btm-img" alt="">
                            </div>
                        </div>
                        <!-- END PAGE TITLE -->
                                ...
                                <div class="row ">
                                    <div class="col-md-3">
                                        <ul class="nav nav-pills nav-stacked">
												{{-- < $name=DB::select("select Distinct(id) from galleryevent  order by id ASC");?> --}}
														{{-- @foreach($name as $event) --}}
															{{-- < $all=DB::select("select * from galleryevent where id=? LIMIT 1 ",[$event->id]);?> --}}
															{{-- @foreach($all as $sub) --}}
															    <li>
															    	{{-- <a data-toggle="tab" href="< echo '#menu'.$sub->id;?>">< echo $sub->event_name;?> --}}
															    	</a>
															    </li>
															{{-- @endforeach
														@endforeach --}}
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="col-md-9 wdp_gallery_magnificPopup tab-pane active" id="menu1">
                                            ...
                                            {{-- @foreach($users as $user)
												@if($user->id==1)
                                            		<a class="col-sm-4 col-xs-6 wdp_gallery_magnificPopup_item wdp_thumbnail" href="< echo 'uploads/purf_gallery/'.$user->images;?>">
                                            		   <img class="img-responsive img-rounded" src="< echo 'uploads/purf_gallery/'.$user->images;?>" style="height:200px;" alt="">
                                            		</a>
										        @endif
											@endforeach --}}
                                        </div>
