...
<body>
	<form method="post" name="customerData" action="ccreq">
		@csrf
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="120962"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://localhost:8000/ccavResponseHandler"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://localhost:8000/ccavResponseHandler"/></td>
			 	</tr>
			 	<tr>
