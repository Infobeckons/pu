  ...
  <title>PunjabUniversity_Rose-Festival</title>
  ...
  <link rel="stylesheet" href="{{ asset('dist/css/material-design-iconic-font.css')}}">
...
<script src="{{url('dist/js/demo.js')}}"></script>
 ...
 <!-- Daterange picker -->
 <link rel="stylesheet" href="{{ asset('plugins/jquery/jquery.js')}}" >
